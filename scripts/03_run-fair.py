...
# %%
emis_df = pd.read_csv('../output/emissions/scenarios_1750-2100.csv')
...
df_volcanic = pd.read_csv('../data/forcing/volcanic_erf_timebounds_2021phaseout.csv', index_col=0)
...
for iscen, scenario in enumerate(tqdm(scenarios)):
    ...
    f.fill_from_csv('../output/emissions/scenarios_1750-2100.csv')
